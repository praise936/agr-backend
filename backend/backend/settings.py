...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY,  # Make sure you have SECRET_KEY in settings
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
...
print("3. About to configure database...")
# DATABASES = {
#     'default': {
...
print("4. Database configured:", DATABASES)
...
STATIC_URL = '/static/'
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'dkdoomay8',
    'API_KEY': '375468754688537',
    'API_SECRET': 'RvigvaO1T0hiCeCKhDLbwx-Mpnk',
}
cloudinary.config(
